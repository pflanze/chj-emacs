...
(put 'lambda-list 'scheme-indent-function 1)
(put 'lambda-values 'scheme-indent-function 1)
(put 'lambda-pair 'scheme-indent-function 1)
(put 'def 'scheme-indent-function
     (lambda (&rest hey)
       ;; (debug)
       ;; (forward-comment (point-max))
       ;;(if (eq (char-after) ?\-) 3 1)
       3))
(put 'def. 'scheme-indent-function
     (lambda (&rest hey)
       ;; (debug)
